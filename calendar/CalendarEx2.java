...
public class CalendarEx2 {
	...
	// 요일은 1부터 시작하기 때문에, DAY_OF_WEEK[0]은 비워두었다.
		...
		// data1.set(2015, Calendar.AUGUST, 15); 와 같이 할 수도 있다.
		...
		System.out.println("그 날(date1)로 부터 오늘(date2)까지 " + difference +"초가 지났습니다.");
		System.out.println("일로 계산하면 " + difference/(24*60*60) + "일입니다."); // 1일 = 24*60*60
